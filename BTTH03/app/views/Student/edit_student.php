        ...
        <div class="mx-5">
            ...
            <form action="?controller=student&action=student_edit" method="post">
                ...
                <div class="input-group flex-nowrap mb-3">
                    ...
                    <input type="text" class="form-control me-5" aria-label="ten_bhat" aria-describedby="addon-wrapping" name="ngaySinh" value="<?php echo $student->getNgaySinh(); ?>">
                </div>
                <div class="input-group flex-nowrap mb-3">
                    <span class="input-group-text ms-5" id="addon-wrapping">Mã lớp học</span>
                    <input type="text" class="form-control me-5" aria-label="ma_tloai" aria-describedby="addon-wrapping" name="idLop" value="<?php echo $student->getIdLop(); ?>">
                </div>
