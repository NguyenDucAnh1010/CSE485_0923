            ...
            <div class="mx-5">
                ...
                <div class="wrapper mt-3">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <?php if ($page > 1) { ?>
                                <li class="page-item"><a class="page-link" href="?controller=cls&action=index&page=<?php echo $page - 1; ?>">Previous</a></li>
                            <?php } ?>
                            ...
                            if ($page<$total/10 || $page+1<$total/10){
                                for ($i = $page; $i <= $page+1; $i++){?>
                                    <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                                        <a class="page-link" href="?controller=cls&action=index&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                    </li>
                            <?php 
                                }
                            }else{ ?>
                                <li class="page-item active">
                                    <a class="page-link" href="?controller=cls&action=index&page=<?php echo $page; ?>"><?php echo $page; ?></a>
                                </li>
                            <?php }?>

                            <?php if ($page <$total/10) { ?>
                                <li class="page-item"><a class="page-link" href="?controller=cls&action=index&page=<?php echo $page + 1; ?>">Next</a></li>
                            <?php } ?>
                        </ul>
                    </nav>
                </div>
