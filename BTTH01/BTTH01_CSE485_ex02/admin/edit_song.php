...
<body class="mx-5">
    ...
    <div class="m-5 text-center">
        <div class="mx-5 row">
            ...
            <form action="../post/post_edit_song.php" method="post">
                <h2 class="mb-4">THÊM MỚI BÀI VIẾT</h2>
                <div class="input-group flex-nowrap mb-3">
                    <span class="input-group-text ms-5" id="addon-wrapping">Mã bài viết</span>
                    <input type="text" class="form-control me-5" aria-label="ma_bviet" aria-describedby="addon-wrapping" name="ma_bviet" value="<?php echo $baiviet[0]['ma_bviet']; ?>" readonly>
                </div>
                <div class="input-group flex-nowrap mb-3">
                    <span class="input-group-text ms-5" id="addon-wrapping">Tiêu đề</span>
                    <input type="text" class="form-control me-5" aria-label="tieude" aria-describedby="addon-wrapping" name="tieude" value="<?php echo $baiviet[0]['tieude']; ?>">
                </div>
                <div class="input-group flex-nowrap mb-3">
                    <span class="input-group-text ms-5" id="addon-wrapping">Tên bài hát</span>
                    <input type="text" class="form-control me-5" aria-label="ten_bhat" aria-describedby="addon-wrapping" name="ten_bhat" value="<?php echo $baiviet[0]['ten_bhat']; ?>">
                </div>
                <div class="input-group flex-nowrap mb-3">
                    <span class="input-group-text ms-5" id="addon-wrapping">Mã thể loại</span>
                    <input type="text" class="form-control me-5" aria-label="ma_tloai" aria-describedby="addon-wrapping" name="ma_tloai" value="<?php echo $baiviet[0]['ma_tloai']; ?>">
                </div>
                <div class="form-floating mx-5 mb-3">
                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="tomtat"><?php echo $baiviet[0]['tomtat']; ?></textarea>
                    <label for="floatingTextarea2">Tóm tắt</label>
                </div>
                <div class="form-floating mx-5 mb-3">
                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="noidung"><?php echo $baiviet[0]['noidung']; ?></textarea>
                    <label for="floatingTextarea2">Nội dung</label>
                </div>
                <div class="input-group flex-nowrap mb-3">
                    <span class="input-group-text ms-5" id="addon-wrapping">Mã tác giả</span>
                    <input type="text" class="form-control me-5" aria-label="ma_tgia" aria-describedby="addon-wrapping" name="ma_tgia" value="<?php echo $baiviet[0]['ma_tgia']; ?>">
                </div>
                <div class="input-group flex-nowrap mb-3">
                    <span class="input-group-text ms-5" id="addon-wrapping">Hình ảnh</span>
                    <input type="text" class="form-control me-5" aria-label="hinhanh" aria-describedby="addon-wrapping" name="hinhanh" value="<?php echo $baiviet[0]['hinhanh']; ?>">
                </div>
