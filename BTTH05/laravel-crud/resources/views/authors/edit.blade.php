        ...
        <div class="mx-5">
            <form action="{{ route('authors.update',$author->id) }}" method="post">
                ...
                <div class="input-group flex-nowrap mb-3">
                    ...
                    <input type="text" class="form-control me-5" aria-describedby="addon-wrapping" name="id" value="{{$author->id}}" readonly>
                </div>
                <div class="input-group flex-nowrap mb-3">
                    <span class="input-group-text ms-5" id="addon-wrapping">name</span>
                    <input type="text" class="form-control me-5" aria-describedby="addon-wrapping" name="name" value="{{$author->name}}">
                </div>
                <div class="form-floating mx-5 mb-3">
                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="bio">{{$author->bio}}</textarea>
